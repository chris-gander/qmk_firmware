...
[_BL] = LAYOUT(
   ...
   */
[_FL] = LAYOUT(
  QK_BOOT,  KC_MYCM,  KC_WHOM,  KC_CALC,  _______,  _______,  _______,  _______,  _______,  KC_PSCR,  KC_MUTE,  KC_VOLD,  KC_VOLU,   KC_INS,   KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_MSTP,
  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,   _______,  _______,  _______,  _______,  _______,
  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,   _______,  _______,  _______,  _______,  _______,
  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,             _______,  _______,  _______,
  _______,  _______,  RGB_SAI,  RGB_SAD,  RGB_SPD,  RGB_SPI,  _______,  NK_TOGG,  _______,  _______,  _______,  _______,  _______,   RGB_VAI,  _______,  _______,  _______,  _______,
...
const key_override_t home_key_override = ko_make_with_layers_negmods_and_options(MOD_MASK_CA, KC_LEFT, KC_HOME, ~0, MOD_MASK_SG, ko_option_no_reregister_trigger);
